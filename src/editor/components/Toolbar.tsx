    ...
    <header className="flex h-11 shrink-0 items-center gap-3 border-b border-border bg-panel px-3">
      ...
      <div className="flex items-center gap-1.5">
        <button
          type="button"
          onClick={onImport}
          className="inline-flex h-7 items-center gap-1.5 rounded-sm border border-border bg-panel-raised px-2.5 text-xs font-medium hover:bg-accent"
        >
        ...
        <button
          type="button"
          disabled
          title="Export rendering arrives in a later phase"
          className="inline-flex h-7 cursor-not-allowed items-center gap-1.5 rounded-sm border border-border bg-panel-sunken px-2.5 text-xs font-medium text-muted-foreground"
        >
          <Download className="h-3.5 w-3.5" /> Export
          <span className="rounded-sm bg-muted px-1 text-[10px] uppercase">soon</span>
        </button>
      </div>
    </header>
  );
